package com.example.tugas_eksperimen_1_daa.PeekSort;

import java.util.Arrays;
import java.util.Random;

import static com.example.tugas_eksperimen_1_daa.PeekSort.MergesAndRuns.*;
...
public class PeekSort implements Sorter {
    ...
    public PeekSort(final boolean onlyIncreasingRuns) {
